...
router.get(
  ...
  PInvoiceApprovalController.getPInvoiceApproval
);
...
router.get(
  "/",
  authMiddleware,
  PInvoiceApprovalController.getAllPInvoiceApprovals
);
...
router.post(
  "/",
  authMiddleware,
  PInvoiceApprovalController.createPInvoiceApproval
);
...
router.put(
  "/:pInvoiceId/:approverId",
  authMiddleware,
  PInvoiceApprovalController.updatePInvoiceApproval
);
...
router.delete(
  "/:pInvoiceId/:approverId",
  authMiddleware,
  PInvoiceApprovalController.deletePInvoiceApproval
);
